...
public class SoundPoolManager {
    ...
    private SoundPoolManager(Context context) {
        ...
        final long[] pattern = {0, 500, 1000, 500, 1000, 500, 1000, 500, 1000};
...
//            vibrator.vibrate(pattern, -1);
        ...
        ringingSoundId = soundPool.load(context, R.raw.android_ring, 1);
        disconnectSoundId = soundPool.load(context, R.raw.android_ring, 1);
    }
